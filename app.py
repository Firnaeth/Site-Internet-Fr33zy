...
CREATEURS = {
    "Firnaeth": {
        ...
        "threads_url": "https://www.threads.net/@firnaeth_yt",
...
if st.session_state.current_profile:
    ...
    with c2:
        ...
        if m.get('threads_url'): liens_html.append(
...
st.markdown("""
    <div style="text-align: center; margin-top: 50px; padding-top: 30px; border-top: 1px solid #30363d;">
        ...
        <p style="font-size: 0.65rem; letter-spacing: 2px; color: #8b949e; text-transform: uppercase; opacity: 0.6;">
            Powered by OBS STUDIO &bull; DAVINCI RESOLVE &bull; STREAMLIT &bull; PHOTOSHOP &bull;
        </p>
    </div>
""", unsafe_allow_html=True)
